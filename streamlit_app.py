...
st.title("국회bot — 검토보고서 자동화")

with st.sidebar:
    st.header("설정")
    api_url = st.text_input("FastAPI 서버 URL", value="http://localhost:8000")
    st.caption("서버가 실행 중이어야 합니다.")
